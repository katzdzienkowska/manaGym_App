...
member_4 = Member("Piotr Krasinski", "1998-02-04", "Core", True)
...
gymclass_1 = Gymclass("Crossfit", "Becky", "2022-06-20", "18:00", 45, 3, True)
...
gymclass_5 = Gymclass("Mobility", "Jacob", "2022-06-29", "15:00", 45, 10, True)
