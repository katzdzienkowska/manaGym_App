...
def gymclasses():
    ...
    return render_template("gymclasses/index.html", gymclasses=all_gymclasses)

# NEW
# GET '/xxx/new'
@gymclasses_blueprint.route("/gymclasses/new", methods = ["get"])
def new_gymclass():
    return render_template("gymclasses/new.html") #add title later
...
def edit_gymclass(id):
    ...
    return render_template("gymclasses/edit.html", gymclass=edit_gymclass)
